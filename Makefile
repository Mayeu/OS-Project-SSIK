...
OBJS_KERNEL= $(addprefix $(BUILD)/, kernel.o asm.o debug.o syscall.o kinout.o kerror.o kprocess.o kprocess_list.o kprogram.o kscheduler.o ksyscall.o kexception.o uart.o splash.o)

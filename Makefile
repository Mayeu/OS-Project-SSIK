...
OBJS_KERNEL= $(addprefix $(BUILD)/, syscall.o kernel.o asm.o debug.o kinout.o kerror.o kprocess.o kprocess_list.o kprogram.o kscheduler.o ksyscall.o kexception.o uart.o splash.o)

...
OBJS_USER= $(addprefix $(BUILD)/, string.o process.o increment.o fibonacci.o stdio.o error.o coquille.o message.o ring.o philosopher.o scroll.o coquille_up.o quit.o supervisor.o)

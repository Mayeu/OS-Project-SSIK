...
OBJS_KERNEL= $(addprefix $(BUILD)/, kernel.o asm.o exception.o debug.o kinout.o kerror.o kpcb.o kprocess.o kprocess_list.o kprogram.o kscheduler.o ksyscall.o kexception.o uart.o splash.o ksleep.o)
OBJS_USER= $(addprefix $(BUILD)/, string.o)
OBJS_TEST= $(addprefix $(BUILD)/, test.o)
TEST_DEPS= $(addprefix $(SRC_TEST)/, test_string.c test_uart_fifo.c test_kprogram.c test_kpcb.c test_kprocess2.c test_kprocess.c test_kprocess_list2.c test_kprocess_list.c test_ksleep.c)

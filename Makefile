...
OBJS_KERNEL= $(addprefix $(BUILD)/, kernel.o asm.o exception.o debug.o kpcb.o kpcb_fifo.o kinout.o kerror.o kprocess.o kprocess_list.o kprogram.o kscheduler.o syscall.o ksyscall.o kexception.o uart.o splash.o ksleep.o)

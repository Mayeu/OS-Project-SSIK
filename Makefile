...
OBJS_KERNEL= $(addprefix $(BUILD)/, syscall.o kernel.o asm.o debug.o kinout.o kerror.o kprocess.o kprocess_list.o kprogram.o kscheduler.o ksyscall.o kexception.o uart.o splash.o kmsg.o)
OBJS_USER= $(addprefix $(BUILD)/, string.o process.o increment.o stdio.o error.o coquille.o message.o)

...
test_kmsg_lst()
{
  ...
  err = (res == OMGROXX) &&
    ...
    (m2->recv_pid == 1) &&
    (m2->pri == 10) &&
    (strcmp(m2->data, "Hello1") == 0) && (m2->datatype == CHAR_PTR);
  test_unit(err, res);
  ...
  err = (res == OMGROXX) &&
    ...
    (m1->recv_pid == 0) &&
    (m1->pri == 10) &&
    (strcmp(m1->data, "Hello2") == 0) && (m1->datatype == CHAR_PTR);
  test_unit(err, res);
  ...
  err = (res == OMGROXX) &&
    ...
    (m1->recv_pid == 0) &&
    (m1->pri == 10) &&
    (strcmp(m1->data, "Hello3") == 0) && (m1->datatype == CHAR_PTR);
  test_unit(err, res);
  ...
  err = (res == OMGROXX) &&
    ...
    (m1->sdr_pid == 1) &&
    (m1->recv_pid == 0) &&
    (m1->pri == 10) && ((int) m1->data == 5) && (m1->datatype == INT_T);
  test_unit(err, res);
  ...
  err = (res == OMGROXX) &&
    (m1->sdr_pid == 1) &&
    (m1->recv_pid == 0) &&
    (m1->pri == 15) && ((int) m1->data == 42) && (m1->datatype == INT_T);
  test_unit(err, res);
  ...
  err = (res == OMGROXX) &&
    (m1->sdr_pid == 1) &&
    (m1->recv_pid == 0) &&
    (m1->pri == 15) && ((int) m1->data == 43) && (m1->datatype == INT_T);
  test_unit(err, res);
